    ...
    <div class="container-fluid bg-color">
        ...
        <div id="site_content">
            <div class="container" style="display: flex; justify-content: center;">
                    ...
                    <p> <small><strong class="define_note"></strong></small>If you already have an account with us, please
                    login at the <a href="login.html"><b>Login Page</b></a>.</p>
                    <form class="form-horizontal" method="POST" action="php/handle_vendor_register.php">
                    <div class="contentText">
                        <fieldset id="account">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="input-firstname"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" required class="form-control" id="input-telephone"
                                        placeholder="Phone Number" value="" name="telephone">
                                </div>
                            </div>
                            <div class="form-group required">
                                <label for="input-address" class="col-sm-2 control-label">Address *</label>
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="input-address"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" required class="form-control" id="input-password"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" required class="form-control" id="input-confirm"
                                        placeholder="Confirm Password" value="" name="confirm">
                                </div>
                            </div>
                        </fieldset>
